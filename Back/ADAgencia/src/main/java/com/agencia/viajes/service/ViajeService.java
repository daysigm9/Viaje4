...
public interface ViajeService {
    ...
    MessageResponse<List<OrigenDestinoDTO>> findOrigenDestinoInt();
    MessageResponse<List<DatosViajesDTO>> findDatosViajesInt(String origen,String destino,String fecha);
